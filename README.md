...
- In the same Terminal Window, run `./adb remount`
...
# (Optional) Confirming Root has worked
...
- From your Teminal window, run the command `./adb install ~/Desktop/SuperSU/common/Terminal.apk` 
